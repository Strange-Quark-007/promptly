        ...
        <section className="w-full max-w-full flex-start flex-col">
            ...
            <form onSubmit={handleSubmit} className="mt-10 w-full max-w-2xl flex flex-col gap-7 glassmorphism">
                ...
                <label>
                    ...
                    <textarea required className="form_textarea" placeholder="Write your prompt here" value={post.prompt}
                        onChange={(e) => {
                ...
                <label>
                    ...
                    <input required className="form_input" placeholder="#tag" value={post.tag}
                        onChange={(e) => {
